...
You can find the Mapper in the Add Activity window - it might be in the recently used list, or alternatively you can use the search box or find it under the **General** collection.  
